...
void ASprintCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	{
		PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &ASprintCharacter::OnFire);
	}

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ASprintCharacter::OnResetVR);
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &ASprintCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate", this, &ASprintCharacter::LookUpAtRate);
}
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			...
			else
			{
				...
				World->SpawnActor<ASprintProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void ASprintCharacter::OnResetVR()
{
...
bool ASprintCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	bool bResult = false;
	if (FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		bResult = true;
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &ASprintCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &ASprintCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &ASprintCharacter::TouchUpdate);
	}
	return bResult;
}
